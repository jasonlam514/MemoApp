...
public class DBAdapter {
	...
	public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_TASK, KEY_DATE, KEY_CONTENT, KEY_TYPE};
	...
	public long insertRow(String task, String date, String content, String type) {
	...
	public boolean updateRow(long rowId, String task, String date, String content, String type) {
		String where = KEY_ROWID + "=" + rowId;
